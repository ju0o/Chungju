...
export function CollageOrnaments({ className = "" }: Props) {
  return (
    <div className={`pointer-events-none absolute inset-0 overflow-hidden ${className}`}>
      ...
      <div className="absolute left-5 top-5 rotate-[-6deg] rounded-[1.1rem] border border-white/70 bg-[rgba(255,252,244,0.74)] px-3 py-2 text-[10px] tracking-[0.14em] text-[var(--foreground-soft)] shadow-[0_10px_20px_rgba(90,75,58,0.08)]">
        PAPER NOTE
      </div>
