      ...
      <div className="relative grid gap-6 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
        <div className="space-y-5">
          ...
          <div className="space-y-3">
            ...
            <h1 className="max-w-[10.5ch] whitespace-pre-line font-[family-name:var(--font-heading)] text-[2.85rem] leading-[1.08] tracking-[-0.04em]">
              {settings.heroTitle}
            </h1>
            <p className="hero-copy max-w-[31ch] text-[0.99rem] text-[var(--foreground-soft)]">{settings.heroDescription}</p>
            <div className="grid gap-2 text-xs tracking-[0.02em] text-[var(--foreground-soft)]">
